...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="bg-white shadow rounded-lg p-6">
        ...
        @endif
            ...
            <a href="{{ route('task-user.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                Add Task
            </a>
        </div>
            ...
            @forelse($tasks as $task)
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2 border-r text-center space-x-2">
                        <a href="{{ route('task-user.edit', $task->id) }}" class="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600">Edit</a>

                        <form action="{{ route('task-user.destroy', $task->id) }}" method="POST" style="display:inline-block;">
                            @csrf
                            @method('DELETE')
